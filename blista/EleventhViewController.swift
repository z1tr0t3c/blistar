...
class EleventhViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        case .wifi:
            ...
            Answers.logContentView(withName: "Kontakt",
                                   contentType: "Kontakt",
                                   contentId: "kontakt",
                                   customAttributes: [:])
            
            webView11.loadRequest(URLRequest(url: URL(string: "https://www.blista.de/kontakt#page-content")!))
        case .cellular:
