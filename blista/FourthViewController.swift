...
class FourthViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        case .wifi:
            ...
            Answers.logContentView(withName: "Speiseplan Vegetarisch",
                                   contentType: "Speiseplan Vegetarisch",
                                   contentId: "speis2",
                                   customAttributes: [:])
            
            webView4.loadRequest(URLRequest(url: URL(string: "https://blista.de/speiseplan-vegetarisch#page-content")!))
        case .cellular:
