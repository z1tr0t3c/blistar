...
class TenthViewController: UIViewController, UIWebViewDelegate {
    
    @IBOutlet weak var webView10: UIWebView!
    ...
    override func viewDidLoad() {
        ...
        case .wifi:
            ...
            webView10.loadRequest(URLRequest(url: URL(string: "https://www.blista.de/content/newsletter#page-content")!))
        case .cellular:
