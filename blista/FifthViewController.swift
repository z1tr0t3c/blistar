...
class FifthViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        case .wifi:
            ...
            Answers.logContentView(withName: "News",
                                   contentType: "News",
                                   contentId: "news",
                                   customAttributes: [:])
            
            webView5.loadRequest(URLRequest(url: URL(string: "https://blista.de/aktuelles#page-content")!))
        case .cellular:
